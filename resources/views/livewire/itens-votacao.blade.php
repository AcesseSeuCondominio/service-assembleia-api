    ...
    @foreach ($items as $item)
        <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-auto">
            <div class="px-5 pb-5 pt-5">
                <a href="#">
                    <h5 class="text-lg font-semibold tracking-tight text-gray-900 dark:text-white">Aprovação do orçamento tal e tal etc e tal</h5>
                </a>
                <div class="flex items-center mt-2.5 mb-5">
                    <span class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">7 votos</span>
                </div>
                <div class="fex items-start mt-2.5 mb-5">
                    Descrição resumida dos itens da votação, da pra inserir bastante texto e tals
                </div>
